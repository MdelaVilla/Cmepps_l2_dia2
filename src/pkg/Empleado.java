...
//		son mayores o iguales que 1000 euros, y de 200 euros si fuese de 1500 euros 
//		o más. Por último, cada hora extra se pagará a 30 euros.
		float salarioBase=0;
		if(tipo.equals(TipoEmpleado.Encargado)) salarioBase=2500;
		else if(tipo.equals(TipoEmpleado.Vendedor)) salarioBase=2000;
		if(ventasMes>=1000) {
			if(ventasMes>=1500)
